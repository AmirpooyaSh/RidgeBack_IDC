...
struct MultiStatus_
{
  ...
  _header_type header;
   ...
   typedef std::vector< ::puma_motor_msgs::Status_<ContainerAllocator> , typename std::allocator_traits<ContainerAllocator>::template rebind_alloc< ::puma_motor_msgs::Status_<ContainerAllocator> >> _drivers_type;
...
bool operator==(const ::puma_motor_msgs::MultiStatus_<ContainerAllocator1> & lhs, const ::puma_motor_msgs::MultiStatus_<ContainerAllocator2> & rhs)
{
